...
<body>
    ...
    ?>
         ...
         <div class="center  mt-0">
          <h5><b>Custmers Details Here..</b></h5>  
          </div>
    <div class="container">
        <br />
        <div class="row">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="center"><a href="userdetails.php?c_id=<?php echo $rows['c_id']; ?>"> <button type="button" class="btn ">View And Transfer</button></a></td>
                                    </tr>
                            <?php
                                }
                            }
